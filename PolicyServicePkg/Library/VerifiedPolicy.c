  ...
  )
{
  ...
  *DataHandle = NULL;
  ...
  Status = PolicyService->GetPolicy (PolicyGuid, NULL, Attributes, &Buffer, &BufferSize);
  ...
  )
{
  ...
  return PolicyService->SetPolicy (PolicyGuid, NULL, Attributes, DataHandle, BufferSize);
}
