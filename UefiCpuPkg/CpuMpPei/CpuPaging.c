...
/**
  Enable/setup stack guard for each processor. // MU_CHANGE Use Memory Protection Hob
  ...
  )
{
  ...
  if (IsIa32PaeSupported ()) {
    ...
    InitStackGuard = TRUE; // PcdGetBool (PcdCpuStackGuard); // MU_CHANGE Use Memory Protection Hob
  }
