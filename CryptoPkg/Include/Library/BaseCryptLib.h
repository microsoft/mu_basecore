/**
  @file BaseCryptLib.h
  @brief This file contains the declarations for the base cryptographic library.
  @defgroup BaseCryptLib Base Cryptographic Library
  @brief Provides functions for cryptographic operations.

  This library provides a comprehensive set of cryptographic primitives including
  HMAC, hashing, symmetric/asymmetric encryption, key derivation, X.509 certificate
  handling, TLS support, and random number generation. All functions use the EFIAPI
  calling convention and are grouped according to their functionality.

  @{
**/

#ifndef BASE_CRYPT_LIB_H_
#define BASE_CRYPT_LIB_H_
