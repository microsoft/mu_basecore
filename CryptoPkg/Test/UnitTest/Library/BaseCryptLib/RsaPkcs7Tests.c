...
extern CONST UINT8  mTrustAnchorTestCert[468];

STATIC CONST UINT8  mRsaSubjectPublicKeyInfoOid[] = {
  0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x01
};

STATIC CONST UINT8  mUnsupportedSubjectPublicKeyInfoOid[] = {
  ...
  )
{
  ...
  FreePool (UnsupportedPublicKeyCert);
