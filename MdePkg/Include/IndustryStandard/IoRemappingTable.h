...
#define EFI_ACPI_IORT_SMMUv3_FLAG_HTTU_OVERRIDE_AF      BIT1  // HW update of Access Flag supported
#define EFI_ACPI_IORT_SMMUv3_FLAG_HTTU_OVERRIDE_AF_DS   BIT2  // HW update of Access Flag + Dirty Flag supported
