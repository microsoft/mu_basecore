...
typedef struct {
  ...
  UINT16               Maxcmd; /* Maximum Outstanding Commands */          // MU_CHANGE - Add Media Sanitize
  ...
  UINT8                Nwpc; /* Namespace Write Protection Capabilities */ // MU_CHANGE - Add Media Sanitize
