  ...
  )
{
  ...
  // PERF_START (Handle, "LoadImage:", NULL, Tick); // MS_CHANGE
  // PERF_END (Handle, "LoadImage:", NULL, 0); // MS_CHANGE
  PERF_LOADIMAGE_END (Handle); // MS_CHANGE
  ...
  )
{
  ...
  // PERF_CODE ( // MS_CHANGE
    // Tick = GetPerformanceCounter (); // MS_CHANGE
  // ); // MS_CHANGE
  PERF_ENTRYPOINT_BEGIN (Handle); // MS_CHANGE
  ...
  if (Image->JumpBuffer == NULL) {
    ...
    //
    // PERF_START (NULL, "StartImage:", NULL, Tick); // MS_CHANGE
    // PERF_END (NULL, "StartImage:", NULL, 0); // MS_CHANGE
  ...
  // Done
  //
  // PERF_START (Handle, "StartImage:", NULL, Tick); // MS_CHANGE
  // PERF_END (Handle, "StartImage:", NULL, 0); // MS_CHANGE
