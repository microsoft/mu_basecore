...
/**
  ...
  @param[in]   NumberOfEvents   The number of events in the UserEvents array
  @param[in]   UserEvents       An array of EFI_EVENT
  @param[out]  UserIndex        Pointer to the index of the event which
                                satisfied the wait condition
