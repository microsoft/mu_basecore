...
// MU_CHANGE [BEGIN] - Delayed Dispatch
...
// MU_CHANGE [END] - Delayed Dispatch
  ...
  do {
    ...
    for (FvCount = Private->CurrentPeimFvCount; FvCount < Private->FvCount; FvCount++) {
           ...
           PeimCount++)
      {
        ...
        // MU_CHANGE [BEGIN] - Dispatch pending delalyed dispatch requests
        if (NULL != Private->DelayedDispatchTable) {
    ...
    // MU_CHANGE - continue dispatch loop if there are outstanding delay-
