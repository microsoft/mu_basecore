...
EDKII_IOMMU_PROTOCOL        *mIoMmu; //MS_CHANGE renamed from mIoMMuProtocol
  ...
  )
{
  ...
  Status = gBS->LocateProtocol (&gEdkiiIoMmuProtocolGuid, NULL, (VOID **)&mIoMmu); //MS_CHANGE renamed mIoMmu
  if (!EFI_ERROR(Status)) {
