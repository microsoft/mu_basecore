/** @file
  Handles non-volatile variable store garbage collection, using the FTW (Fault Tolerant Write) protocol.
...
/**
  Gets the Logical Block Address (LBA) of a block and offset by given address.

  This function gets the Logical Block Address (LBA) of a firmware volume block containing the given address,
  and the offset of the address on the block.

  @param[in]   Address   Address which should be contained in the returned FVB handle.
