...
{  
  ...
  EXCLUDED_HOB_DATA *ExcludedHobData;  //mschange
  EFI_PEI_FIRMWARE_VOLUME_INFO_MEASUREMENT_EXCLUDED_PPI *MeasurementExcludedFvPpi; //mschange
  UINT32 Instance; //mschange
  UINT32 Count; //mschange
  UINT32 HobIndex; //mschange
  EFI_STATUS Status; //mschange
  ...
  PERF_CALLBACK_END(PERF_VERBOSITY_STANDARD, &gEfiEndOfPeiSignalPpiGuid); // MS_CHANGE
