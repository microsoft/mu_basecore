...
STATIC CONST ECIT_FEATURE_NAME  mFeatureNames[] = {
  { &gEfiEcitFeatureSbImageVerificationGuid,           "Secure Boot Image Verification"            },
  { &gEfiEcitFeatureSbImageAuthorizationGuid,          "Secure Boot Image Authorization"           },
  { &gEfiEcitFeatureSbDatabaseUpdateAuthorizationGuid, "Secure Boot Database Update Authorization" },
  { &gEfiEcitFeatureSbImageRevocationGuid,             "Secure Boot Image Revocation"              },
  { &gEfiEcitFeatureSbDatabaseUpdateVerificationGuid,  "Secure Boot Database Update Verification"  },
...
{
  return (BOOLEAN)(
                   CompareGuid (Feature, &gEfiEcitFeatureSbImageVerificationGuid) ||
                   CompareGuid (Feature, &gEfiEcitFeatureSbDatabaseUpdateVerificationGuid) ||
...
{
  return (BOOLEAN)(
                   CompareGuid (Feature, &gEfiEcitFeatureSbImageAuthorizationGuid) ||
                   CompareGuid (Feature, &gEfiEcitFeatureSbDatabaseUpdateAuthorizationGuid) ||
                   CompareGuid (Feature, &gEfiEcitFeatureSbImageRevocationGuid)
                   );
}
...
STATIC CONST ECIT_SIGLIST_TYPE_NAME  mSigListTypeNames[] = {
  ...
  { EFI_CERT_V2_X509_GUID,        "X.509 certificate (V2)"       },
  { EFI_CERT_SHA1_GUID,           "SHA-1 image hash"             },
  { EFI_CERT_SHA256_GUID,         "SHA-256 image hash"           },
  { EFI_CERT_V2_SHA256_GUID,      "SHA-256 image hash (V2)"      },
  { EFI_CERT_SHA384_GUID,         "SHA-384 image hash"           },
  { EFI_CERT_V2_SHA384_GUID,      "SHA-384 image hash (V2)"      },
  { EFI_CERT_SHA512_GUID,         "SHA-512 image hash"           },
  { EFI_CERT_V2_SHA512_GUID,      "SHA-512 image hash (V2)"      },
  { EFI_CERT_X509_SHA256_GUID,    "X.509 TBS hash (SHA-256)"     },
  { EFI_CERT_V2_X509_SHA256_GUID, "X.509 TBS hash (SHA-256, V2)" },
  { EFI_CERT_X509_SHA384_GUID,    "X.509 TBS hash (SHA-384)"     },
  { EFI_CERT_V2_X509_SHA384_GUID, "X.509 TBS hash (SHA-384, V2)" },
  { EFI_CERT_X509_SHA512_GUID,    "X.509 TBS hash (SHA-512)"     },
  { EFI_CERT_V2_X509_SHA512_GUID, "X.509 TBS hash (SHA-512, V2)" },
};
