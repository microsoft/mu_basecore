...
//
// Image Authenticode digest under the unsupported SHA-1 algorithm (EFI_CERT_SHA1_GUID); used to
// verify the handler neither approves nor revokes an image by a SHA-1 digest.
//
#define DB_STATE_IMAGE_DIGEST_SHA1  0x20000000                     ///< Loaded image's SHA-1 Authenticode digest (unsupported algorithm).
