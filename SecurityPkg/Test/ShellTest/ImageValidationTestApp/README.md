...
- Test data blobs (images, digests, certificates) are generated by `GenTestData.py`; see
  that script's header comment or run `python3 GenTestData.py --help` to regenerate them.
  Each generated `TestData.c` also points back to the script.
