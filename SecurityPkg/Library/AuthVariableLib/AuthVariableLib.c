...
EFI_GUID mSignatureSupport[] = {EFI_CERT_SHA1_GUID, EFI_CERT_SHA256_GUID, EFI_CERT_RSA2048_GUID, EFI_CERT_X509_GUID, EFI_CERT_VERSION_RECORD_RESOURCE_GUID}; // MU_CHANGE add SBAT as a signature
