...
# MU_CHANGE [BEGIN] - Remove libraries referencing openssl which is no longer in CryptoPkg
...
# MU_CHANGE [END]
  ...
  #IntrinsicLib|CryptoPkg/Library/IntrinsicLib/IntrinsicLib.inf   MU_CHANGE - Remove crypto libraries moved
