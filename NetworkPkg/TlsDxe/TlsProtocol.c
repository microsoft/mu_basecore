  ...
  )
{
  ...
  UINTN                     CipherCount;
  CONST EFI_TLS_VERIFY_HOST *TlsVerifyHost;   // MU_CHANGE - Proposed fixes for TCBZ960, invalid domain name (CN) accepted.
  EFI_TLS_VERIFY            VerifyMethod;     // MU_CHANGE - Proposed fixes for TCBZ960, invalid domain name (CN) accepted.
  UINTN                     VerifyMethodSize; // MU_CHANGE - Proposed fixes for TCBZ960, invalid domain name (CN) accepted.
  UINTN                     Index;
  ...
  Status = EFI_SUCCESS;
  CipherId = NULL;
  VerifyMethodSize = sizeof (EFI_TLS_VERIFY);  // MU_CHANGE - Proposed fixes for TCBZ960, invalid domain name (CN) accepted.
