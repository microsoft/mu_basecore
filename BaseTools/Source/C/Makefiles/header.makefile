...
BUILD_CC ?= $(GCC5_AARCH64_PREFIX)gcc
BUILD_CXX ?= $(GCC5_AARCH64_PREFIX)g++
BUILD_AS ?= $(GCC5_AARCH64_PREFIX)gcc
BUILD_AR ?= $(GCC5_AARCH64_PREFIX)ar
BUILD_LD ?= $(GCC5_AARCH64_PREFIX)ld
endif
LINKER ?= $(BUILD_CC)
ifeq ($(HOST_ARCH), IA32)
