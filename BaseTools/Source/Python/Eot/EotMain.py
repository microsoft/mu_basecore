...
class CompressedImage(Image):
    ...
    def _GetSections(self):
        try:
            ...
            DecData = array('B')
            DecData.frombytes(TmpData) # MU_CHANGE use frombytes instead of fromstring
        except:
...
class Ui(Image):
    ...
    def _GetUiString(self):
        return codecs.utf_16_decode(self[0:-2].tobytes())[0] # MU_CHANGE use tobytes instead of tostring
